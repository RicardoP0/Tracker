...
<button id="play-btn" style="height: 25px; width: 25px;" class="stop">▶</button>
...
<script>
    ...
    var playing = false;
    // Load the data.
    d3.json("vendor/dragit/data/nations.json", function(nations) {
        ...
        setTimeout(function() {
            if(first_time) {
                play_demo()
                demo_interval = setInterval(play_demo, 2000)
            }
        }, 1000);
    });
</script>
