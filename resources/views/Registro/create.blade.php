            ...
            <div class="panel-body" >
                ...
                <!--preguntas-->
                    <div id="div_id_username" class="form-group required">
                        <label for="id_username" class="control-label col-md-4  requiredField">Nombre usuario<span class="asteriskField">*</span> </label>
                        <div class="controls col-md-8 ">
                            <input class="input-md  textinput textInput form-control" id="id_username" maxlength="30" name="username" placeholder="Escriba su usuario" style="margin-bottom: 10px" type="text" required/>
                        </div>
                    </div>
                    ...
                    <div id="div_id_name" class="form-group required">
                        ...
                        <div class="controls col-md-8 ">
                            <input required class="input-md textinput textInput form-control" id="id_name" name="name" placeholder="Ingrese su nombre" style="margin-bottom: 10px" type="password" />
                        </div>
                    </div>
                    ...
                    <div id="div_id_gender" class="form-group required">
                        ...
                        <div class="controls col-md-8 "  style="margin-bottom: 15px">
                            <label class="radio-inline"> <input type="radio" required name="gender" id="id_gender_1" value="M"  style="margin-bottom: 10px">Masculino</label>
                            <label class="radio-inline"> <input type="radio" required name="gender" id="id_gender_2" value="F"  style="margin-bottom: 10px">Femenino </label>
                        </div>
                    </div>
                    ...
                    <div id="div_id_date" class="form-group required">
                        ...
                        <div class="controls col-md-8 ">
                            <input required id="date" type="date" style="margin-bottom: 10px">
                        </div>
                    </div>
